...
app()->group('/solped', function () {
    ...
    $this->post('/cliente/conclude-treatment', 'App\Http\Controllers\Customer\SolpedController:concludeTreatment')->add(new AuthMiddleware())->setName('solped.concludeTreatment');
