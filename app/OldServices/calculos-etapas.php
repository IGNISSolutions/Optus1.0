        ...
        if ($economic_proposal) {
            ...
            if ($economicByRound) {
                ...
                $ConcursoEconomicas = [
                    ...
                    'razonSocial'         => isset($oferente->company) ? $oferente->company->business_name : null,
                    'email'               => isset($oferente->company) ? $oferente->company->email : null,
                    'telefono'            => isset($oferente->company) ? ($oferente->company->phone ?: $oferente->company->cellphone) : null,
                    'direccion'           => isset($oferente->company) ? $oferente->company->address : null,
