                ...
                if (response.success) {
                    ...
                    $('#calendar').fullCalendar({
                        ...
                        eventClick: function(calEvent, jsEvent, view) {
                            ...
                            // === Mapa por CLASE: coincide con DashboardController (oferente) ===
                            const classToStep = {
                                'invitacion-color':   'invitacion',
                                'muro-color':         'chat-muro-consultas',
                                'tecnica-color':      'tecnica',
                                'economica-color':    'economica',
                                'adjudicacion-color': 'adjudicado'
                            };

                            // === Fallback por TEXTO (variantes frecuentes en oferente) ===
                            const etapaToStep = {
                                // Invitación
                                'invitacion pendiente': 'invitacion',
                                ...
                                // Técnica
                                'evaluacion tecnica': 'tecnica',
                                'tecnica pendiente':  'tecnica',
                                'tecnica':            'tecnica',

                                // Económica
                                'evaluacion economica': 'economica',
                                'economica pendiente':  'economica',
                                'economica':            'economica',

                                // Adjudicación
                                'adjudicacion pendiente': 'adjudicado',
                                'adjudicacion':           'adjudicado'
                            };

                            const step = classToStep[classKey] || etapaToStep[etapaKey] || 'invitacion';
