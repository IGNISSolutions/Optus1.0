<h4 class="block bold" style="margin-top: 0; padding-top: 0;">Adjudicación manual</h4>
...
<table class="table table-striped table-bordered" id="manualAdjudication">
    ...
    <tbody
        data-bind="dataTablesForEach: { data: $root.ManualAdjudication().items, as: 'adjudication_item', options: { paging: false, searching: false, ordering: false }}">
        <tr>
            ...
            <td class="vertical-align-middle text-center">
                <span data-bind="number: offerer() ? offerer().priceShow : null, precision: 2"></span>
            </td>
            <td class="vertical-align-middle text-center">
            ...
            <td class="vertical-align-middle text-center">
                <span data-bind="number: total(), precision: 2"></span>
            </td>
    ...
    <tbody data-bind="visible: $root.ManualAdjudication().items().length > 0">
        <tr>
            ...
            <td class="text-bold vertical-align-middle text-center">
                <span data-bind="number: $root.ManualAdjudication().total(), precision: 2"></span>
            </td>
            <td></td>
        </tr>
    </tbody>
...
<!-- ko if: $root.AlgunoPresentoEconomica() && !$root.Adjudicado() && !$root.Eliminado() -->
<div class="row">
    <div class="col-md-12">
        <div class="form-group text-right">
            <label class="control-label visible-ie8 visible-ie9" style="display: block;">&nbsp;</label>
            <button data-bind="click: $root.AdjudicationItemAddOrDelete.bind($data, 'add'), disable: $root.IsChainApprover()" class="btn btn-xl btn-success"
                title="Agregar Item">
